...
public class PayPalActivity extends Activity {
	 ...
	 private static final String TAG = "paymentExample";
	    ...
	    private static final String CONFIG_CLIENT_ID = "Ad-iwxBZKzcCobNuH621s03dMgzgfrL5-27uYltcJIi_-F10yfO_MYtOvkni";
	  ...
	  String bidAmount;
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	     ...
	     { extras = getIntent().getExtras();
	    	 bidAmount = String.valueOf(extras.getString("BidAmount"));
	     }
	    ...
	    private PayPalPayment getThingToBuy(String paymentIntent) {
	        return new PayPalPayment(new BigDecimal(bidAmount), "USD", "BabySitter",
	                paymentIntent);
	    }
